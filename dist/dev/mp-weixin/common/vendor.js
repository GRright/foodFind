...
const pages = [
  ...
  {
    path: "pages/shoppingList/shoppingList",
    style: {
  ...
  {
    path: "pages/mealConfig/mealConfig",
    style: {
      navigationBarTitleText: "用餐配置",
      navigationBarBackgroundColor: "#ffffff",
      navigationBarTextStyle: "black",
      backgroundColor: "#f7f8fa"
    }
  ...
  {
    path: "pages/familyCheckIn/familyCheckIn",
    style: {
      navigationBarTitleText: "打卡看板",
      navigationBarBackgroundColor: "#ffffff",
      navigationBarTextStyle: "black",
      backgroundColor: "#f7f8fa"
    }
  ...
  {
    path: "pages/familyReport/familyReport",
    style: {
...
const Yt = { REQUEST: "request", RESPONSE: "response", BOTH: "both" }, Qt = "_globalUniCloudStatus", Xt = "_globalUniCloudSecureNetworkCache__{spaceId}", Zt = "uni-secure-network", en = { SYSTEM_ERROR: { code: 2e4 }, APP_INFO_INVALID: { code: 20101, message: "Invalid client" } };
function nn(e2) {
...
(() => {
  ...
  if (e2 && 1 === e2.length)
    ...
    let s2;
    s2 = e2 && e2.length > 0 ? "应用有多个服务空间，请通过uniCloud.init方法指定要使用的服务空间" : "uni-app cli项目内使用uniCloud需要使用HBuilderX的运行菜单运行项目，且需要在uniCloud目录关联服务空间", [...t3, ...n2].forEach((e3) => {
      er[e3] = function() {
